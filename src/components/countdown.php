<section>
    <div class="sticker">
        <div class="countdown--container">
            <h6>Essa temporada se inicia em:</h6><br/>
            <div class="clock">
                <svg aria-hidden="true" focusable="false" data-prefix="fal" data-icon="alarm-clock" role="img"
                     xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                     class="svg-inline--fa fa-alarm-clock fa-w-16 fa-9x">
